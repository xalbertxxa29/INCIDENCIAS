...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function cargarClientes() {
    try {
        ...
        createSearchableDropdown(registerClienteInput, registerClienteList, clientes, (clienteSeleccionado) => {
            // Callback que se ejecuta al seleccionar un cliente
  ...
  // Esconder desplegables si se hace clic afuera
  ...
  // --- LÓGICA DE REGISTRO (ADAPTADA) ---
  registerForm.addEventListener("submit", async e => {
    e.preventDefault();
    loadingOverlay.hidden = false;

    // Obtener valores de los nuevos inputs de búsqueda
    ...
    try {
        ...
        // La lógica para guardar en CLIENTE_UNIDAD ahora está en el iframe, ya no se necesita aquí.
